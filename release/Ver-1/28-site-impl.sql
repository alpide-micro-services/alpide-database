...
CREATE TABLE IF NOT EXISTS client_relationship_hierarchy_ref (
    ...
    FOREIGN KEY (parent_rid) REFERENCES client_relationship(rid),
    FOREIGN KEY (child_rid)  REFERENCES client_relationship(rid),
    INDEX idx_ref_type (relationship_type)
    );

-- 3. Franchisee-specific agreement terms
CREATE TABLE IF NOT EXISTS franchisee_terms (
                                                id                    BIGINT        AUTO_INCREMENT PRIMARY KEY,
    ...
    FOREIGN KEY (franchisee_rid)    REFERENCES client_relationship(rid),
    FOREIGN KEY (parent_branch_rid) REFERENCES client_relationship(rid),
